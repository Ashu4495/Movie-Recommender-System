...
# Pickle
bz2.BZ2File(os.path.join(MODELS_DIR, 'similarity.pbz2'), 'wb').write(pickle.dumps(similarity))
pickle.dump(new_df.to_dict(), open(os.path.join(MODELS_DIR, 'movies_dict.pkl'), 'wb'))

print(f"Generated similarity.pbz2 and movies_dict.pkl in {MODELS_DIR} successfully!")
